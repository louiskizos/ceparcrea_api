"""
Django settings for Avec_api project.
...
STATIC_URL = '/static/'
STATIC_ROOT = '/home/c2798164c/ceparcrea/staticfiles'  # Ou os.path.join(BASE_DIR, 'staticfiles')

# 3. Utiliser WhiteNoise pour compresser et servir les statiques
